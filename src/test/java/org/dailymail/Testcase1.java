...
import org.dailymail.constants.Constants;
...
public class Testcase1 extends BaseUI {
    ...
    public void setUsername(){
        ...
        login.usernametextbox(Constants.PLACEHOLDER_TEXT_EMAIL_FIELD);
    }
    @Test(priority = 3)
    public void setPassword(){
        Login login = new Login(logger,driver);
        login.passwordtextbox(Constants.PLACEHOLDER_TEXT_PASSWORD_FIELD);
    }
    @Test(priority = 4)
